...
export default function Join({ address, mainnetProvider, userProvider, localProvider, yourLocalBalance, price, tx, readContracts, writeContracts }) {
            ...
            <div style={{ border: "1px solid #cccccc", padding: 16, width: 400, margin: "auto", marginTop: 64 }}>
                ...
                <div style={{ margin: 8 }}>
                    ...
                    <Button onClick={() => {
                        ...
                        /* look how you call setPurpose on your contract: */
                        tx(writeContracts.YourContract.confirmPurchase(newPurpose))
                    }}>Set Purpose</Button>
                </div>
